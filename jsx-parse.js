export { parseWrapper as default, SyntaxError }
...
const { parse, SyntaxError } =
	...
	(function () {
		...
		function peg$parse(input, options) {
			...
			var peg$startRuleFunctions = { __Start: peg$parse__Start }
			var peg$startRuleFunction = peg$parse__Start

			var peg$c0 = "PLACEHOLDER"
			var peg$c1 = "["
			var peg$c2 = "]"
			var peg$c3 = "<"
			var peg$c4 = "/>"
			...
			var peg$e0 = peg$literalExpectation("PLACEHOLDER", false)
			...
			var peg$f1 = function (id2, i) {
				return id2 === id
			}
			var peg$f2 = function (id2, i) {
				return inserts[i]
			}
			var peg$f3 = function (Tag, props) {
				return props
			}
			var peg$f4 = function (Tag, props) {
				return createElement(Tag, props)
			}
			var peg$f5 = function (Tag, props) {
				return props
			}
			var peg$f6 = function (Tag, props, children, Close) {
				return Tag === Close
			}
			var peg$f7 = function (Tag, props, children, Close) {
				return createElement(Tag, props, ...children)
			}
			var peg$f8 = function (attr) {
				return attr
			}
			var peg$f9 = function (rest, last, spread) {
			...
			function peg$parseElement() {
				...
				s0 = peg$parseVoidElement()
				if (s0 === peg$FAILED) {
					s0 = peg$parseContentElement()
				}
			...
			function peg$parseContentElement() {
